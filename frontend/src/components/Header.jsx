    ...
    <header className="bg-slate-900/95 backdrop-blur-md text-white shadow-2xl sticky top-0 z-50 border-b border-slate-700/50 py-2">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items center">
        <Link to="/" className="flex items-center space-x-2 group shrink-0">
          ...
          <span className=" text-lg sm:text-xl font-black tracking-tighter uppercase text-white group-hover:text-teal-400 transition-colors">Prep<span className="text-teal-500">With</span><span className="hidden sm:inline">AI</span></span>
        </Link>
        <nav className="hidden md:flex items-center space-x-6">
          {user ? (<>
            ...
            <div className="flex items-center space-x-2 bg-slate-800/50 px-4 py-1.5 rounded-full border border-slate-700">
              ...
              <span className="text-xs font-bold text-slate-300 uppercase">{user?.name?.split(" ")[0] || "User"}</span>
            </div>
